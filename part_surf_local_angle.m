function y = part_surf_local_angle(p,x0,y0,z0,phi,th,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by)
...
%%and use it to pass only one variable to zs function
 ...
 if (th>pi/2.0 && th<pi) %particle facing downwards
       if (phi==0) %%y=y0, tan(phi)=0
          ...
          xs=fzero(@(x) zpx(x,x0,z0,th,phi)-zs(x,y0,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by), x0); 
          ys=y0;
          q=zs(xs,ys,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by); 
       elseif (phi==pi/2.0) %%xs=x0, tan(phi)->inf.
          ys=fzero(@(y) zpy(y,y0,z0,th,phi)-zs(x0,y,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by), y0); 
          xs=x0; 
          q=zs(xs,ys,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by);
       else
           
        ys=fzero(@(y) zpy(y,y0,z0,th,phi)-zs(x0+(y-y0)/tan(phi),y,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by), y0);         
        xs=x0+(ys-y0)/tan(phi); 
        q=zs(xs,ys,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by); 
...
%ns=[-dzs/dx,-dzs/dy,1]; 
nsx=-dzsx(xs,ys,A,SX1,RX1,BX1,CX1,SX2,RX2,BX2,CX2,bx,by);
nsy=-dzsy(xs,ys,A,SY1,RY1,BY1,CY1,SY2,RY2,BY2,CY2,bx,by);
nsz=1.0;
ns=[nsx,nsy,nsz];
